...
class DataBase
{
     ...
     * @param int $deviceID
     * @param 'mail'|'adWatched'|'cheatSuspicion'|'appState'|'accountState'|'accountEdition'|'giftCodeTry'|'giftCode'|'buyDailyDeals'|'buyRandomChest'|'buyTargetedChest'|'buyDye'|'sellStuff'|'error' $type
     * @param string $data
     * @return void
     */
