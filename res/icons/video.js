...
const SvgComponent = (props) => (
  <Svg viewBox='0 0 24 24' {...props}>
    ...
    <Path
      fillRule='evenodd'
      d='M2 12c0-1.237 0-2.311.026-3.25h19.948C22 9.689 22 10.763 22 12c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Zm11.014.585C14.338 13.44 15 13.867 15 14.5s-.662 1.06-1.986 1.915c-1.342.866-2.013 1.299-2.514.98-.5-.317-.5-1.176-.5-2.895s0-2.578.5-2.896c.5-.318 1.172.115 2.514.981Z'
    />
    <Path d='M21.896 7.25c-.147-1.764-.503-2.928-1.36-3.786-.598-.597-1.344-.95-2.337-1.16L14.9 7.25h6.995Z' />
  </Svg>
);
